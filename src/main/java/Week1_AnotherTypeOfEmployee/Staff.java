...
//-----------------------------------------------------------------
    public Staff ()
    {
        staffList = new StaffMember[8]; //changed from 6 to 8
        ...
        staffList[5] = new Volunteer ("Cliff", "321 Duds Lane",
                "555-7282");
        staffList[6] = new Commision ("Salman", "Jati", "123", "321", 6.25, .2);
        staffList[7] = new Commision ("Akbar", "Rumah", "444", "3453", 9.75, .15);
